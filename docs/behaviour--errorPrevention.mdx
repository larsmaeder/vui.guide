...
path: /docs/behaviour/prevent-and-recover-from-errors/
category: behaviour
sort: 6
toc: true
---

![Prevent and recover from errors.](/images/behaviour/preventAndInterceptErrors.png)
...
![Prevent errors within a conversation.](/images/behaviour/errorPrevention.png)
...
![Prevent errors within a conversation with a visual design pattern.](/images/behaviour/errorPreventionWithList.png)
...
![Provide a help function.](/images/behaviour/helpDocumentation.png)
