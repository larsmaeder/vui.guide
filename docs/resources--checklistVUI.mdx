...
navDocTitle: Voice user interface
path: /docs/resources/checklist/vui
toc: false
---

<InfoBox>
  If you can answer with details or a simple <strong>yes</strong> to a question,
  tick it. There are matching links to articles to help you find an answer if
...
<Checkbox
  title="Does the VUI provide shortcuts to users to improve the conversation?"
  desc="Improve user task efficiency by providing links like chips. Contrary to pronouncing user intent, this can be a useful and faster alternative."
>
  <a href="/docs/behaviour/handling-user-intents/" target="_blank">
    Handling user inputs
  </a>
  <a href="/docs/design-patterns/chip/" target="_blank">
    Chip
  </a>
</Checkbox>
<Checkbox
  title="Does the VUI use any design patterns and are they used correctly?"
  desc="Use design patterns correctly to solve common design problems."
>
  <a href="/docs/design-patterns/card/" target="_blank">
    Card
  </a>
  <a href="/docs/design-patterns/carousel/" target="_blank">
    Carousel
  </a>
  <a href="/docs/design-patterns/lsit/" target="_blank">
    List
  </a>
  <a href="/docs/design-patterns/chip/" target="_blank">
    Chip
  </a>
  <a href="/docs/design-patterns/table/" target="_blank">
    Table
  </a>
  <a href="/docs/design-patterns/audio-card/" target="_blank">
    Audio card
  </a>
</Checkbox>
...
<Checkbox
  title="Does your VUI provide conversation status feedback?"
...
<Checkbox
  title="Does the VUI minimize the amount of information in dialogue and design?"
