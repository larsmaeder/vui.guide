...
Creating a voice user interface is complex and difficult, because otherwise the vui.guide would somehow be redundant – I hope not. As we learned from the <GatsbyLink to="/docs/behaviour/behaviour-of-speak#do-what-humans-already-do/">behavior of speak</GatsbyLink> part, it is also difficult to remember every detail. This can also be applied to understanding this guide.
