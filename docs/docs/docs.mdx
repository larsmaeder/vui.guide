...
Navigate through the guide with the menu bar on the left. There is a resource area with useful tools and a <GatsbyLink to="/docs/resources/checklist/">checklist</GatsbyLink> that gives you an overview of the most important points and helps you step by step in creating a design for a voice user interface.
...
Visit the <GatsbyLink to="/contribute/">contribute</GatsbyLink> section for instructions on how to start contributing to the voice user interface guide.
