...
![Speech behaviour](/images/behaviour/speechBehaviour.png)
...
![Reduce complexity to a certain extent without shortening the content too much.](/images/behaviour/doWhatHumansAlreadyDo.png)
