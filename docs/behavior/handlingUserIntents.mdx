...
slug: /docs/behaviour/handling-user-intents/
category: Behaviour
sort: 2.7
toc: true
...
heroImage: ./images/handlingUserIntents.png
heroImageAlt: Handling user intents.
---
...
![Structure of a command: intent, utterance and slot.](/images/intentUtteranceSlot.png)
...
A good way to improve efficiency is using the design pattern <GatsbyLink to="/docs/design-patterns/chip/">Chips</GatsbyLink>. Chips are used to provide a quick way to respond in a conversation without voice interaction.
