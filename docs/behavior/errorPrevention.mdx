...
navDocTitle: Prevent and recover from errors
slug: /docs/behaviour/prevent-and-recover-from-errors/
category: Behaviour
sort: 2.6
toc: true
...
heroImage: ./images/preventAndInterceptErrors.png
heroImageAlt: Prevent and recover from errors.
---
...
![Prevent errors within a conversation.](./images/errorPrevention.png)
...
![Prevent errors within a conversation with a visual design pattern.](/images/errorPreventionWithList.png)
...
![Provide a help function.](/images/helpDocumentation.png)

![Interface with examples of possible commands.](/images/UserFreedomExamples.png)
