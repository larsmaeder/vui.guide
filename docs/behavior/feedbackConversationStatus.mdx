...
slug: /docs/behaviour/feedback-of-conversation-status/
category: Behaviour
sort: 2.4
toc: true
...
heroImage: ./images/feedbackOfConversationStatus.png
heroImageAlt: Feedback of conversation status.
---
...
![Visual cues (lights, light patterns) on a physical product.](/images/twitter-jankolario-bifCXiN5rdY-unsplash.png)
...
![On-screen message to display specific information to the user.](/images/feedback.png)
...
![Telling the user the VUI is waiting.](/images/waiting.png)
...
![Telling the user the VUI is listening.](/images/listening.png)
...
![Playing animation while the VUI is thinking and processing the user intent.](/images/thinking.gif)
...
![Telling the user the VUI is speaking or has spoken.](/images/replying.gif)
...
![Telling the user what exactly occurred the incomprehension and how he can resolve this error.](/images/incomprehension.png)
...
![Telling the user the VUI is waiting.](/images/confirmation.png)
...
![Telling the user he can speak or that he is speaking.](/images/userSpeaks.gif)
